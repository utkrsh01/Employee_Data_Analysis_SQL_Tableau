...
/*Creating a visualization that provides a breakdown between the male and female employees working in the company
...
and adding a filter following you to see that per each department.*/
...
/*Created an SQL stored procedure that will allow us to obtain the average male and female salary per department 
within a certain salary range. This range be defined by two values the user can insert when calling the procedure.*/
